...
<img className={imgClasses} src={img} alt="Fayoum University College building" loading="lazy" />
     <div  data-aos="zoom-in-up"
        ...
        <h1 className='md:text-3xl  text-xl font-bold text-[#000000]'>The origin of the college :</h1>
             ...
             <h2 className='  m-[10px] dark:text-white/50 text-base md:text-xl font-[600] text-black/80 '>All universities and international scientific 
             ...
             <h3 className='m-[10px] text-base md:text-xl font-[500] dark:text-white/50 text-black/80 '>
