...
const Login = () => {
  ...
  //const [div2, setresetPass] = useState("");
...
<section className="bg-gray-1 dark:bg-dark py-20 lg:py-[120px]">
   <div    data-aos="fade-up"
    ...
    lg:right-[35%] `} >
        ...
        <input
        className="w-[70%] h-8 rounded-3xl border-none outline-none p-2 border"
        required
        placeholder="E-mail :"
        type="email"
        value={email}
        onChange={(eo) => setEmail(eo.target.value)} // تحديث البريد الإلكتروني عند الكتابة
      />
      <button
        className={`hover:text-red-700 px-4 py-2 rounded ${
          email.trim() === "" ? "bg-black/10 cursor-not-allowed" : " cursor-pointer bg-red-500 text-white"
        }`}
        disabled={email.trim() === ""||!(email.includes('@gmail.com')) } // تعطيل الزر إذا لم يُدخل المستخدم بريدًا
        onClick={(eo) => {
          eo.preventDefault();
      ...
      {messageVisible === true ? (
        <p className="text-green-600">✅ Please check your email to reset your password.</p>
        ...
        <p className="text-red-600"> Please Enter Email.</p>
         ...
         <div  className="shadow-2xl w-full px-4">
            <div 
               ...
               <form>
                  <div data-aos="zoom-in-down"
                                    data-aos-delay={ 500 } className=" shadow-2xl  mb-6">
                     <input
                        type="text"
                        placeholder="Email"
                  ...
                  <div  data-aos="zoom-in-down"
                                    data-aos-delay={ 700 } className="shadow-2xl mb-6">
                     <input
                        type="password"
               ...
               <ul  className="flex justify-between mb-12 -mx-2">
                  <li data-aos="zoom-in-up"
                                    data-aos-delay={ 200 }className=" shadow-2xl w-full px-2">
                     <a
                        href="javascript:void(0)"
                        className="flex h-11 items-center justify-center rounded-md bg-[#ac4040] hover:bg-opacity-90"
                        >
                        <svg
                           width="10"
                           height="20"
                  ...
                  <li data-aos="zoom-in-down"
                                    data-aos-delay={ 1200 } className="w-full px-2">
                     <a
                        href="javascript:void(0)"
                  ...
                  <li data-aos="zoom-in-up"
                                    data-aos-delay={ 700 } className="w-full px-2">
                     <a
                        href="javascript:void(0)"
        ...
        data-aos-delay={ 600 } onClick={() => {
              forgotPassword()
            }}
                  href="javascript:void(0)"
                  className="inline-block mb-2 text-base text-dark dark:text-white  hover:text-red-600 hover:underline"
                  >
               Forget Password?
               </a>
